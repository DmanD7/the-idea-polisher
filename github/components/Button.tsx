...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-gradient-to-r from-[#52b788] to-[#40916c] text-white hover:from-[#40916c] hover:to-[#2d6a4f] shadow-[0_4px_14px_0_rgba(82,183,136,0.3)] hover:shadow-[0_8px_25px_rgba(82,183,136,0.4)]",
